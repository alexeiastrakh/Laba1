...
public interface ICalculatorVisitor<Result> : IParseTreeVisitor<Result> {
	...
	Result VisitParenthesizedExpr([NotNull] CalculatorParser.ParenthesizedExprContext context);
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitUnaryExpr([NotNull] CalculatorParser.UnaryExprContext context);
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitExponentialExpr([NotNull] CalculatorParser.ExponentialExprContext context);
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitMultiplicativeExpr([NotNull] CalculatorParser.MultiplicativeExprContext context);
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitAdditiveExpr([NotNull] CalculatorParser.AdditiveExprContext context);
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitModDivExpr([NotNull] CalculatorParser.ModDivExprContext context);
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitNumberExpr([NotNull] CalculatorParser.NumberExprContext context);
